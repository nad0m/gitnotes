...
;(() => {
  ...
  var e = {
      ...
      9282: (e) => {
        ...
        function B(e) {
          return !!e && (e.endsWithParent || B(e.starts))
        }
        function W(e) {
          const n = {
            ...
            function f() {
              null != _.subLanguage
                ? (function () {
                    ...
                    } else e = m(C, _.subLanguage.length ? _.subLanguage : null)
              ...
              r.createElement(
                ...
                e.map((e) => {
                  ...
                  return r.createElement(
                    ...
                    r.createElement(
                      'div',
                      { className: 'action-duration', style: { flex: 'none' } },
                      d.endTime
      ...
      1984: (e, n, t) => {
        ...
        n.CallTab = ({ action: e }) => {
          ...
          const s = Object.keys(c),
            u = new Date(e.metadata.wallTime).toLocaleString(),
            d = (0, a.msToString)(e.metadata.endTime - e.metadata.startTime)
          return r.createElement(
            'div',
            { className: 'call-tab' },
            r.createElement(
            ...
            r.createElement(
              r.Fragment,
              null,
              r.createElement('div', { className: 'call-section' }, 'Time'),
              r.createElement(
                'div',
                { className: 'call-line' },
                'wall time: ',
                r.createElement('span', { className: 'datetime', title: u }, u)
              ),
              r.createElement(
                'div',
                { className: 'call-line' },
                'duration: ',
                r.createElement('span', { className: 'datetime', title: d }, d)
              )
            ),
            !!s.length &&
              r.createElement(
      ...
      7394: (e, n) => {
        Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.indexModel = function (e) {
            for (const n of e.pages) n[t] = e
            for (let n = 0; n < e.actions.length; ++n) {
              const o = e.actions[n]
              ;(o[t] = e), (o[r] = e.actions[n + 1])
            }
            for (const n of e.events) n[t] = e
          }),
          (n.context = i),
          (n.next = l),
          (n.stats = function (e) {
      ...
      4035: (e, n, t) => {
        ...
        n.SnapshotTab = ({ action: e, defaultSnapshotInfo: n }) => {
          ...
          if (e) {
            ...
            if (n && n.snapshotName) {
              ...
              ;(b = new URL(
                ...
                (d = new URL(
                  `snapshotInfo/${e.metadata.pageId}?trace=${t}&name=${n.snapshotName}`,
                  window.location.href
                ).toString()),
          ...
          const w = v.viewport,
            E = Math.min(t.width / w.width, t.height / w.height, 1),
            k = w.width * E,
            x = w.height * E
          return r.createElement(
            'div',
            ...
            r.createElement(
              'div',
              { className: 'snapshot-url', title: v.url },
              v.url
            ),
            r.createElement(
              'div',
              ...
              r.createElement(
                'div',
                {
                  ...
                  style: {
                    ...
                    height: w.height + 'px',
                    transform: `translate(${
                      (-w.width * (1 - E)) / 2 + (t.width - k) / 2
                    }px, ${
                      (-w.height * (1 - E)) / 2 + (t.height - x) / 2
                    }px) scale(${E})`
                  }
                },
      ...
      3600: (e, n, t) => {
        ...
        async function s(e) {
          const n = new TextEncoder().encode(e),
            t = await crypto.subtle.digest('SHA-1', n),
            r = [],
            o = new DataView(t)
          for (let e = 0; e < o.byteLength; e += 1) {
            const n = o.getUint8(e).toString(16).padStart(2, '0')
            r.push(n)
          }
          return r.join('')
        }
            ...
            m = (0, o.useAsyncMemo)(
              async () => {
                ...
                if ('string' == typeof b) e = b
                  ...
                  const n = b.frames[u].file
                  if (!b.fileContent.has(n)) {
                    const e = await s(n)
                    b.fileContent.set(
                      n,
                      await fetch(`sha1/src@${e}.txt`)
                        .then((e) => e.text())
                        .catch((e) => `<Unable to read "${n}">`)
                    )
                  }
                  e = b.fileContent.get(n)
                }
                return e
              },
              [b, u],
          ...
          const [m, h] = (0, o.useMeasure)(),
            ...
            x = r.useMemo(() => {
              ...
              for (const r of e.actions) {
                let e = u(r.metadata.params.selector || '', 50)
                'goto' === r.metadata.method &&
                  (e = u(r.metadata.params.url || '', 50)),
                  t.push({
                    action: r,
                    leftTime: r.metadata.startTime,
                    rightTime: r.metadata.endTime,
                    leftPosition: c(m.width, n, r.metadata.startTime),
                    rightPosition: c(m.width, n, r.metadata.endTime),
                    label: r.metadata.apiName + ' ' + e,
                    type: r.metadata.type + '.' + r.metadata.method,
                    className:
                      `${r.metadata.type}_${r.metadata.method}`.toLowerCase()
                  })
              }
              for (const r of e.events) {
                const e = r.metadata.startTime
                t.push({
                  event: r,
                  leftTime: e,
                  rightTime: e,
                  leftPosition: c(m.width, n, e),
                  rightPosition: c(m.width, n, e),
                  label: r.metadata.method,
                  type: r.metadata.type + '.' + r.metadata.method,
                  className:
                    `${r.metadata.type}_${r.metadata.method}`.toLowerCase()
                })
      ...
      3463: (e, n, t) => {
        ...
        n.Workbench = () => {
          const [e, n] = l.useState(
            ...
            [v, y] = l.useState(),
            [w, E] = l.useState('logs'),
            [k, x] = l.useState({ done: 0, total: 0 }),
            [S, _] = l.useState(!1),
            N = (e) => {
              const t = URL.createObjectURL(e),
                r = new URL(window.location.href)
              r.searchParams.set('trace', t)
              const o = r.toString()
              window.history.pushState({}, '', o), n(t), _(!1)
            }
          l.useEffect(() => {
            ;(async () => {
              if (e) {
                const n = (e) => {
                  'progress' === e.data.method && x(e.data.params)
                }
                navigator.serviceWorker.addEventListener('message', n),
                  x({ done: 0, total: 1 })
                const t = await fetch(`context?trace=${e}`).then((e) =>
                  e.json()
                )
          ...
          const O = {
              viewport: t.options.viewport || { width: 1280, height: 720 },
              url: ''
            },
            C = { minimum: t.startTime, maximum: t.endTime }
          C.maximum += (C.maximum - C.minimum) / 20
          const { errors: T, warnings: M } = m
              ? b.stats(m)
              : { errors: 0, warnings: 0 },
            L = [
              {
                ...
                title: 'Call',
                count: 0,
                render: () => l.createElement(d.CallTab, { action: m })
              },
              {
                id: 'console',
                title: 'Console',
                count: T + M,
                render: () => l.createElement(p.ConsoleTab, { action: m })
              },
              {
                id: 'network',
                title: 'Network',
                count: m ? b.resourcesForAction(m).length : 0,
                render: () => l.createElement(c.NetworkTab, { action: m })
              }
            ]
          return (
            ('localhost' !== window.location.hostname &&
              ...
              L.push({
                ...
                title: 'Source',
                count: 0,
                render: () => l.createElement(s.SourceTab, { action: m })
              }),
            l.createElement(
              'div',
              {
              ...
              l.createElement(
                ...
                l.createElement('div', { className: 'logo' }, '🎭'),
                l.createElement('div', { className: 'product' }, 'Playwright'),
                t.title &&
                  l.createElement('div', { className: 'title' }, t.title),
              ...
              l.createElement(
                ...
                l.createElement(
                  ...
                  l.createElement(u.SnapshotTab, {
                    action: m,
                    defaultSnapshotInfo: O
                  }),
                  l.createElement(a.TabbedPane, {
                    tabs: L,
                    selectedTab: w,
                    setSelectedTab: E
                  })
                ),
                l.createElement(o.ActionList, {
                  actions: t.actions,
                  selectedAction: m,
                  highlightedAction: v,
                  onSelected: (e) => {
              ...
              !!k.total &&
                l.createElement(
                  ...
                  l.createElement('div', {
                    ...
                    style: { width: (100 * k.done) / k.total + '%' }
                  })
                ),
              !S &&
                !e &&
                l.createElement(
                  ...
                  l.createElement('input', {
                    type: 'file',
                    onChange: (e) => {
                      e.preventDefault(), e.target.files && N(e.target.files[0])
                    }
                  })
                ),
              S &&
                l.createElement(
                  'div',
                  {
                    ...
                    onDrop: (e) =>
                      ((e) => {
                        e.preventDefault(), N(e.dataTransfer.files[0])
                      })(e)
                  },
        ...
        const g = (0, r.createEmptyContext)()
        ;(g.startTime = performance.now()), (g.endTime = g.startTime)
      },
      3804: (e, n) => {
        Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      4448: (e, n, t) => {
        ...
        function On(e) {
          ...
          var n,
            t = Sn[e]
          for (n in t) if (t.hasOwnProperty(n) && n in Nn) return (_n[e] = t[n])
          return e
        }
        d &&
        ...
        function _a(e) {
          ...
          function b(e, n, t, r, o) {
            ...
            if ('object' == typeof r && null !== r) {
              ...
              if (ka(r) || W(r)) return d(n, (e = e.get(t) || null), r, o, null)
              Sa(n, r)
            }
            return null
          }
        ...
        function Va(e) {
          ...
          if (
            ...
            for (n = Ua; n; ) Wa(e, n), (n = Zr(n.nextSibling))
          if ((qa(e), 13 === e.tag)) {
          ...
          } else Ua = Fa ? Zr(e.stateNode.nextSibling) : null
          return !0
        }
        function Za() {
          ;(Ua = Fa = null), (Ba = !1)
        ...
        function Bi(e, n, t) {
          ...
          if ('hidden' === r.mode || 'unstable-defer-without-hiding' === r.mode)
            if (0 == (4 & n.mode))
              (n.memoizedState = { baseLanes: 0 }), yc(0, t)
            else {
              if (0 == (1073741824 & t))
                return (
        ...
        function pc(e, n) {
          ...
          if (((r = zn(e, e === Ml ? Pl : 0)), (n = jn), 0 === r))
            ...
            15 === n
              ? ((t = hc.bind(null, e)),
                null === Fo ? ((Fo = [t]), (Uo = No(Po, Qo))) : Fo.push(t),
                (t = Do))
              : 14 === n
        ...
        function Mc(e, n) {
          ...
          if (
            ...
            ;(Br = { focusedElem: l, selectionRange: c }),
              (Qn = !1),
              (lc = null),
              (cc = !1),
              (Vl = r)
            ...
            ;(Qn = !!Ur), (Br = Ur = null), (e.current = t), (Vl = r)
            do {
              try {
                for (y = e; null !== Vl; ) {
                  var x = Vl.flags
        ...
        function $c(e, n) {
          ...
          return (
            null === t
              ? (((t = Bc(e.tag, n, e.key, e.mode)).elementType =
                  e.elementType),
                (t.type = e.type),
        ...
        function Hc(e, n, t, r, o, a) {
          ...
          if (((r = e), 'function' == typeof e)) Wc(e) && (l = 1)
            ...
            e: switch (e) {
              ...
              case M:
                return (
                  ((e = Bc(13, t, n, o)).type = M),
                  (e.elementType = M),
                  (e.lanes = a),
                  e
                )
              case L:
                return ((e = Bc(19, t, n, o)).elementType = L), (e.lanes = a), e
              case D:
                return Vc(t, o, a, n)
              case z:
                return ((e = Bc(24, t, n, o)).elementType = z), (e.lanes = a), e
              default:
        ...
        function qc(e, n, t, r) {
          return ((e = Bc(7, e, r, n)).lanes = t), e
        }
        function Vc(e, n, t, r) {
          return ((e = Bc(23, e, r, n)).elementType = D), (e.lanes = t), e
        }
        function Zc(e, n, t) {
          return ((e = Bc(6, e, null, n)).lanes = t), e
        }
        function Kc(e, n, t) {
          return (
            ((n = Bc(
        ...
        function ns(e, n, t) {
          ...
          if (
            ...
            (n = Bc(3, null, null, 2 === n ? 7 : 1 === n ? 3 : 0)),
            (t.current = n),
            (n.stateNode = t),
            ca(n),
            (e[Jr] = t.current),
              ...
              if (
                ...
                if (
                  ((a = (o = n.stateNode).hydrate) &&
                    ((Ua = Zr(n.stateNode.containerInfo.firstChild)),
                    (Fa = n),
                    (a = Ba = !0)),
                  a)
                ) {
