...
class Tracing {
  ...
  async startChunk(options = {}) {
    ...
    this._appendTraceOperation(async () => {
      ...
      await _fs.default.promises.appendFile(
        state.traceFile,
        JSON.stringify({ ...this._contextCreatedEvent, title: options.title }) +
          '\n'
      )
    })
  ...
  async stopChunk(save, skipCompress) {
    ...
    return (
      (await this._appendTraceOperation(async () => {
        ...
        const zipArtifact = skipCompress
          ? null
          : await this._exportZip(entries, state).catch(() => null)
        return {
  ...
  async onBeforeCall(sdkObject, metadata) {
    ...
    ;(_sdkObject$attributio = sdkObject.attribution.page) === null ||
    _sdkObject$attributio === void 0
      ? void 0
      : _sdkObject$attributio.temporarlyDisableTracingScreencastThrottling() // Set afterSnapshot name for all the actions that operate selectors.
  ...
  async onBeforeInputAction(sdkObject, metadata, element) {
    ...
    ;(_sdkObject$attributio2 = sdkObject.attribution.page) === null ||
    _sdkObject$attributio2 === void 0
      ? void 0
      : _sdkObject$attributio2.temporarlyDisableTracingScreencastThrottling()
  ...
  async onAfterCall(sdkObject, metadata) {
    ...
    ;(_sdkObject$attributio3 = sdkObject.attribution.page) === null ||
    _sdkObject$attributio3 === void 0
      ? void 0
      : _sdkObject$attributio3.temporarlyDisableTracingScreencastThrottling()
