        ...
        const r = {
          ...
          p = {
            matches(e, t, n, o) {
              ...
              return 'self' === v(o, e, g(t[0], 2 === t.length ? t[1] : void 0))
            }
          },
          f = {
            matches(e, t, n, o) {
    ...
    var h = class {
      constructor(e, t) {
        ...
        ;(n.textContent =
          ...
          e.onGlobalListenersRemoved.add(() =>
            this._refreshListenersIfNeeded()
          ),
      ...
      async _pollRecorderMode() {
        var e
        this._pollRecorderModeTimer && clearTimeout(this._pollRecorderModeTimer)
        const n = await globalThis._playwrightRecorderState().catch((e) => null)
        if (!n)
